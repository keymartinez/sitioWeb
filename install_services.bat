...
REM .\bin\mariadb\mariadb10.6.5\bin\mysql_install_db.exe --datadir=c:/dolibarr/bin/mariadb/data --port=3310 --password=WAMPMYSQLXXX >> doliwamp.log 2>>&1
.\bin\mariadb\mariadb10.6.5\bin\mysql_install_db.exe --datadir=c:/dolibarr/bin/mariadb/data --port=3310 >> doliwamp.log 2>>&1
